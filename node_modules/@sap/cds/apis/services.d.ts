import { SELECT, INSERT, UPDATE, DELETE, Query, ConstructedQuery } from '@sap/cds/apis/ql'
import { LinkedModel, Definition, Definitions } from '@sap/cds/apis/reflect'
import { csn, type } from "@sap/cds/apis/csn"
